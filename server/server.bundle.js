...
var removeFromQueue = function removeFromQueue(queueId) {
  ...
  return db.Queue.find({ where: { id: queueId }, include: [db.Restaurant] }).then(function (row) {
    ...
    return db.Restaurant.upsert({ 'total_wait': restaurant.total_wait - restaurant.average_wait, phone: restaurant.phone });
  }).then(function () {
...
var redisconfig = __webpack_require__(42);

/* Import React modules for server rendering */

var customerTemplate = __webpack_require__(41);
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                { className: 'wait-time' },
                'wait time: ',
                this.props.restaurant.total_wait - this.props.restaurant.average_wait,
                ' mins'
              ),
              _react2.default.createElement(
                'span',
